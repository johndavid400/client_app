...
Given /^an application exists with email "([^"]*)" and name "([^"]*)"$/ do |email, name|
  ...
  @application = FactoryGirl.create :client_application, email: email, business_name: name, user: @user, phone_number: "555-555-5555", years_in_business: "2", number_of_employees: "2", business_address: "200 street", billing_address: "300 street", city: "Topeka", zip: "20020", state: alabama
  @application.submit!
end
