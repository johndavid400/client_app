...
a = ClientApplication.new(:business_name => "Tom's Plumbing", :taxpayer_id_number => "34034903490", :business_address => "293 4th street S.", :business_website => "business.com", :billing_address => "3409 1st street", :parent_company => "ABC Holdings Inc", :dba_name => "Tom's plumbing", :city => "Birmingham", :state_id => 1, :contact_by_email => 1, :phone_number => "205-434-3434", :years_in_business => "12", :number_of_employees => "23", :zip => "35206", :email => "tom@tom.com", :progress => 25, :first_name => "Tom", :last_name => "Jenkins", :business_type => "private", :revenue => "$100")
...
b = ClientApplication.create(:business_name => "John's Carpentry", :taxpayer_id_number => "33422333490", :business_address => "343 6th street S.", :business_website => "carpentry.com", :billing_address => "9489 9th street", :parent_company => "XYZ Holdings Inc", :dba_name => "John's Carpentry", :city => "Birmingham", :state_id => 1, :contact_by_email => 1, :phone_number => "205-323-3232", :years_in_business => "5", :number_of_employees => "6", :zip => "35206", :email => "john@john.com", :progress => 50, :first_name => "John", :last_name => "Cooper", :business_type => "private", :revenue => "$100")
...
c = ClientApplication.create(:business_name => "Mark's Lawn service", :taxpayer_id_number => "09092332390", :business_address => "389 8th street S.", :business_website => "markslawn.com", :billing_address => "903 4th street", :parent_company => "Grass Cutters Inc", :dba_name => "Mark's Lawn service", :city => "Birmingham", :state_id => 1, :contact_by_email => 1, :phone_number => "205-234-0434", :years_in_business => "32", :number_of_employees => "13", :zip => "35206", :email => "mark@mark.com", :progress => 75, :first_name => "Mark", :last_name => "Thomas", :business_type => "private", :revenue => "$100")
...
d = ClientApplication.create(:business_name => "Terry's Painting", :taxpayer_id_number => "3413490409", :business_address => "123 Thomas street", :business_website => "business.com", :billing_address => "39 2nd street", :parent_company => "Painters Inc", :dba_name => "Terry's painting", :city => "Birmingham", :state_id => 1, :contact_by_email => 1, :phone_number => "205-433-8884", :years_in_business => "3", :number_of_employees => "3", :zip => "35206", :email => "terry@terry.com", :progress => 100, :first_name => "Terry", :last_name => "Bradshaw", :business_type => "private", :revenue => "$100")
